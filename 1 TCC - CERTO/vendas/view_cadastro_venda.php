...
<body>
	...
	<div class="div-cadastro">
			<form method="POST" action="cadastro_venda.php" class="form-cadastro">
				<!-------PRODUTO--------venda[0]-->
				<div class="textfield">
					<label>Produto:</label>
					<select class="selects" name="venda[]">
						<option>Selecione</option>
							<?php foreach($produtos as $produto){ ?>
							<option><?php echo"$produto[nome_produto]<br>";} ?></option>
					</select>
				</div><br>
				<!--------------------------->


				<!-------QUANTIDADE-PRODUTO-----venda[1]-->
				<div>
					<label class="textfield">Quantidade produto:</label>
					<input class="quant-prod" type="text" name="venda[]">
				</div><br>
				<!--------------------------->


				<!--------NOME-CLIENTE--------venda[2]-->
				<div class="textfield">
				...
				<!-------DATA-HORA-----venda[3]-->
				<div>
					<label class="textfield">Data e Hora:</label>
					<input class="quant-prod" type="datetime-local" name="venda[]">
				</div><br>
				<!--------------------------->
